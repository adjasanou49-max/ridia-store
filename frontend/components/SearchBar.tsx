      ...
      <form onSubmit={handleSubmit}>
        <div className="relative">
          <input
            ...
            className="w-full bg-gray-50 border border-gray-200 rounded-full pl-4 pr-16 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:bg-white"
          />
          {query && (
            <button
              type="button"
